function polopolyedit_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
polopolyedit_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				polopolyedit_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
polopolyedit_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
polopolyedit_xmlhttpRequester.prototype.setupRequestEvent =
